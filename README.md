...
Системный монитор в стиле с бэкендом на C++ и веб-интерфейсом на TypeScript. Данные передаются через WebSocket в реальном времени. Работает на Linux; проверен на Ubuntu 22.04.5 LTS.
